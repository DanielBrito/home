          ...
          <Grid item lg={7}>
            <Fade>
              <div style={{ backgroundColor: "#000000" }}>
                ...
                After studying in different public schools, I got accepted at the Faculty of Technology (FATEC) to study Analysis and Systems Development. However, in search of new challenges, I decided to move to Crateús to study Computer Science at the Federal University of Ceará (UFC), where I've gotten some scholarships to work in projects in the field of web development, computer graphics, and education. As described on my <a href="https://drive.google.com/file/d/1bOFjCfhoyabvcZ7LXf5T3EtY9h6umsaR/view" target="_blank" rel="noopener noreferrer" className={classes.externalLink} style={{ textDecoration: "none", color: "white" }} title="Read">resumé</a> and <a href="http://lattes.cnpq.br/6587136026055239" target="_blank" rel="noopener noreferrer" className={classes.externalLink} style={{ textDecoration: "none", color: "white" }} title="Access">lattes curriculum</a>, currently, I'm an intern developing intelligent applications to the health public system management.
              </p>
              </div>
            </Fade>
          </Grid>
          ...
          <Grid item lg={7}>
            <Fade>
              <div style={{ backgroundColor: "#000000" }}>
                ...
                <p style={{ color: "#FFFFFF", fontSize: "16px", textAlign: "justify" }}>
                  I idealized the project <Link to="/projects#compixelar" style={{ textDecoration: "none" }} title="More" className={classes.externalLink}>COMPIXELAR</Link>. I'm a <Link to="/books#zines" style={{ textDecoration: "none" }} title="More" className={classes.externalLink}>FANZINER</Link>. I built the <Link to="/projects#halugar" style={{ textDecoration: "none" }} title="More" className={classes.externalLink}>HáLUGAR</Link> app. I'm the creator of <Link to="/projects#aluminions" style={{ textDecoration: "none" }} title="More" className={classes.externalLink}>ALUMINIONS</Link>. I'm a thinker at <Link to="/projects#fora_da_caixa" style={{ textDecoration: "none" }} title="More" className={classes.externalLink}>FORA DA CAIXA</Link>. I'm a tailleur at <Link to="/projects#antigrife" style={{ textDecoration: "none" }} title="More" className={classes.externalLink}>ANTIGR1F3</Link>. I'm a curator at <Link to="/projects#galeria_marginal" style={{ textDecoration: "none" }} title="More" className={classes.externalLink}>GALERIA MARGINAL</Link>. I'm a kind of YouTuber, who likes to talk about <Link to="/videos#programming" style={{ textDecoration: "none" }} title="More" className={classes.externalLink}>PROGRAMMING</Link>. I'm a worker at <Link to="/projects#concretagens" style={{ textDecoration: "none" }} title="More" className={classes.externalLink}>COLETIVA CONCRETAGENS</Link>. I disseminate Philosophy and Art through the <Link to="/projects#socrastickers" style={{ textDecoration: "none" }} title="More" className={classes.externalLink}>SOCRASTICKERS</Link>.<br /><br />
                  ...
                  I published independently the book <Link to="/books#protestizando" style={{ textDecoration: "none" }} title="More" className={classes.externalLink}>PROTESTIZANDO</Link> (2015), which compiles my first poems. I published independently the book <Link to="/books#a_ler_vazios" style={{ textDecoration: "none" }} title="More" className={classes.externalLink}>A LER VAZIOS</Link> (2016), which includes some of my poetic and visual experiments. I've also been published in several anthologies with other marginal authors.<br /><br />
          ...
          <Grid item lg={7}>
            <Fade>
              <div style={{ backgroundColor: "#000000" }}>
                ...
                <p style={{ color: "#FFFFFF", fontSize: "16px", textAlign: "justify" }}>
                  After escaping from Plato's cave, John Keating taught me to seize the day in order to make my life extraordinary.<br /><br />

                  Through the exact sciences, I get fascinated as I discover the cosmos. Through the social sciences, I seek to understand the world that I live in and the several cultures that surround me. Through technology, I try to create solutions that promote social progress.<br /><br />

                Riding BMX and skateboarding provide me some good doses of adrenaline. Calisthenics and <a href="https://lichess.org/@/danielbrito41" target="_blank" rel="noopener noreferrer" className={classes.externalLink} style={{ textDecoration: "none", color: "white" }} title="Lichess profile">neurobics</a> help me to train my body and my mind.<br /><br />

                I bring with me an increasing appreciation for the <a href="https://filmow.com/usuario/daniel_brito/" target="_blank" rel="noopener noreferrer" className={classes.externalLink} style={{ textDecoration: "none", color: "white" }} title="Filmow profile">Seventh Art</a>, and my <a href="https://open.spotify.com/user/xb93kruabsjskn5chjqo127ep?si=oWza3WozRimzC7rt965_ww" target="_blank" rel="noopener noreferrer" className={classes.externalLink} style={{ textDecoration: "none", color: "white" }} title="Spotify profile">musical taste</a> ranges from tuned pianos to distorted guitars.<br /><br />

                I value respect about every sentient being, as well as the DIY attitude, the self-teaching lifestyle, <a href="https://www.duolingo.com/DanBrito41" target="_blank" rel="noopener noreferrer" className={classes.externalLink} style={{ textDecoration: "none", color: "white" }} title="Duolingo profile">polyglotism</a>, and <Link to="/blog" style={{ textDecoration: "none" }} title="More" className={classes.externalLink}>polymathy</Link>.<br /><br />
