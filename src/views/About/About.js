      ...
      <div className={classNames(classes.main, classes.mainRaised)}>
          ...
          <Grid item lg={7}>
            <Fade>
              <div style={{ backgroundColor: "#000000" }}>
                <h1 style={{ color: "#FFFFFF", textAlign: "center", marginTop: "0px" }}><em>MY BRIEF HISTORY</em></h1>
        ...
        <Grid container spacing={5} justify="center" alignItems="center" direction="row-reverse" style={{ marginTop: "50px", marginBottom: "50px" }}>
          ...
          <Grid item lg={7}>
            <Fade>
              <div style={{ backgroundColor: "#000000" }}>
                <h1 style={{ color: "#FFFFFF", textAlign: "center", marginTop: "0px" }}><em>TO BE OR NOT TO BE</em></h1>
                <p style={{ color: "#FFFFFF", fontSize: "16px", textAlign: "justify" }}>
        ...
        <Grid container spacing={5} justify="center" alignItems="center" style={{ marginTop: "50px" }}>
          ...
          <Grid item lg={7}>
            <Fade>
              <div style={{ backgroundColor: "#000000" }}>
                <h1 style={{ color: "#FFFFFF", textAlign: "center", marginTop: "0px" }}><em>LIFE, THE UNIVERSE AND EVERYTHING</em></h1>
                <p style={{ color: "#FFFFFF", fontSize: "16px", textAlign: "justify" }}>
