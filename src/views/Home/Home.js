      ...
      <div className={classNames(classes.main, classes.mainRaised)}>
            ...
            <Fade>
              <div style={{ backgroundColor: "#000000" }}>
                <Link to="/books" style={{ textDecoration: "none" }} title="More">
                  <h1 className={classes.linkTitle} style={{ color: "#FFFFFF", textAlign: "center", marginTop:"0px" }}>A LER VAZIØS</h1>
                </Link>
        ...
        <Grid container spacing={5} justify="center" alignItems="center" direction="row-reverse" style={{marginTop: "50px", marginBottom: "50px"}} >
          ...
          <Grid item lg={7}>
            <Fade>
              <div style={{ backgroundColor: "#000000" }}>
                <p style={{ color: "#FFFFFF", fontSize: "19px", textAlign: "justify", marginTop: "0px" }}>
                ...
                <Link to="/books" style={{ textDecoration: "none" }} title="More">
                  <span className={classes.link} style={{ color: "#FFFFFF", fontSize: "19px", textAlign: "center" }}><strong>- Sophia (PROTESTIZANDO)</strong></span>
                </Link>
              </div>
            </Fade>
          </Grid>
        ...
        <Grid container spacing={5} justify="center" alignItems="center" style={{marginTop: "50px", marginBotto: "50px"}}>
          <Grid item lg={5}>
            <div>
              <Zoom>
          ...
          <Grid item lg={7}>
            <Fade>
              <div style={{ backgroundColor: "#000000" }}>
                ...
                <Link to="/books" style={{ textDecoration: "none" }} title="More">
                  <span className={classes.link} style={{ color: "#FFFFFF", fontSize: "19px", textAlign: "center" }}><strong>- Antonio Miotto (A LER VAZIOS)</strong></span>
                </Link>
              </div>
            </Fade>
          </Grid>
        ...
        <Grid container spacing={5} justify="center" alignItems="center" direction="row-reverse" style={{marginTop: "50px", marginBotto: "50px"}}>
          <Grid item lg={5}>
            <div>
              <Zoom>
          ...
          <Grid item lg={7}>
            <Fade>
              <div style={{ backgroundColor: "#000000" }}>
                ...
                <Link to="/books" style={{ textDecoration: "none" }} title="More">
                  <span className={classes.link} style={{ color: "#FFFFFF", fontSize: "19px", textAlign: "center" }}><strong>- Léssio Cardoso (A LER VAZIOS)</strong></span>
                </Link>
              </div>
            </Fade>
          </Grid>
          ...
          <Grid item lg={7}>
            <Fade>
              <div style={{ backgroundColor: "#000000" }}>
                ...
                <Link to="/books" style={{ textDecoration: "none" }} title="More">
                  <span className={classes.link} style={{ color: "#FFFFFF", fontSize: "19px", textAlign: "center" }}><strong>- Casulo (A LER VAZIOS)</strong></span>
                </Link>
              </div>
            </Fade>
          </Grid>
