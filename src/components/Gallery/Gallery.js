...
const titles = [
  ...
  <span style={{ color: "#39ff14", fontWeight: "bold" }}>Fanzine #5</span>,
  <span style={{ color: "#39ff14", fontWeight: "bold" }}>
    Debugging HáLugar app
  </span>,
  <span style={{ color: "#39ff14", fontWeight: "bold" }}>Concretagens</span>,
  <span style={{ color: "#39ff14", fontWeight: "bold" }}>
    PROTESTIZANDO release
  </span>,
  ...
  <span style={{ color: "#39ff14", fontWeight: "bold" }}>EXPO ESIA</span>,
  <span style={{ color: "#39ff14", fontWeight: "bold" }}>
    Sobrenome Liberdade
  </span>,
  <span style={{ color: "#39ff14", fontWeight: "bold" }}>SOCRASTICKERS</span>,
